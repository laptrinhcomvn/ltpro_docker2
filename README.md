...
docker image build -t laptrinhcomvn/ltpro_nginx:1.2.7 -t laptrinhcomvn/ltpro_nginx:latest -f Dockerfile_nginx .
...
```bash
docker image push laptrinhcomvn/ltpro_nginx:1.2.7
